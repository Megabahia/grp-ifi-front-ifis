 ...
 * IFIS
 * Ifis
 * Esta pantalla sirve para listar un prospecto de cliente
 * Rutas:
 * `${apiUrl}/mdm/prospectosClientes/list/`,
 * `${environment.apiUrl}/central/param/list/tipo/todos/`,
 * `${environment.apiUrl}/central/param/list/filtro/nombre`,
 * `${apiUrl}/adm/usuarios/list/rol/`,
 * `${apiUrl}/mdm/prospectosClientes/create/`,
...
export class ProspectosClientesListComponent implements OnInit, AfterViewInit {
  ...
  async obtenerProvincias() {
    ...
    await this.paramService
      .obtenerListaHijos(this.pais, 'PAIS')
      .subscribe((info) => {
  ...
  async obtenerCiudad() {
    await this.paramService
      .obtenerListaHijos(this.provincia, 'PROVINCIA')
      .subscribe((info) => {
  ...
  async obtenerProspectos() {
    await this.paramService
      .obtenerListaPadres('CONFIRMACION_PROSPECTO')
      .subscribe((info) => {
  ...
  async obtenerTiposPrecio() {
    await this.paramService
      .obtenerListaPadres('TIPO_PRECIO')
      .subscribe((info) => {
  ...
  eliminarProspectoModal() {
    this.prospectosService
      .eliminarProspecto(this.idProspecto)
      .subscribe((info) => {
        this.obtenerListaProspectos();
        this.cerrarModal();
      });
