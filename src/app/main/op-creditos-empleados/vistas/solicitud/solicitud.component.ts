 ...
 * IFIS
 * Ifis
 * Esta pantalla sirve para mostrar las solicitudes de credito empleados
 * Rutas:
...
@Component({
  selector: 'app-solicitud-emp',
  templateUrl: './solicitud.component.html',
  styleUrls: ['./solicitud.component.scss'],
  encapsulation: ViewEncapsulation.None,
  host: {class: 'ecommerce-application'}
})
export class SolicitudEmpComponent implements OnInit, AfterViewInit, OnDestroy {
